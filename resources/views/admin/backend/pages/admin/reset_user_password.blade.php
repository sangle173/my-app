    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                <h5 class="mb-4">Reset QA Password</h5>
                <form id="myForm" action="{{ route('admin.reset.user.password',$user->id) }}" method="post"
                    ...
                    <div class="form-group col-md-12">
                        <label for="name" class="form-label">QA Name</label>
