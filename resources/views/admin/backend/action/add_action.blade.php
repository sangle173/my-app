    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                <h5 class="mb-4">Add Action</h5>
                <form id="myForm" action="{{ route('store.action') }}" method="post" class="row g-3"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="icon" id="inlineRadio1" value="book-bookmark">
                            <label class="form-check-label" for="inlineRadio1"><i class='bx bxs-book-bookmark'></i></label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="icon" id="inlineRadio2" value="bug-alt">
