...
@php
  ...
  $course = App\Models\Course::latest()->get();
@endphp

<div class="page-content">

  @if ($status === '1')
  <h4>Xin chào <span class="text-success">{{$name}}</span> </h4>
  @else
           ...
           <div class="card-body">
               <div class="d-flex align-items-center">
                   <div>
                       ...
                       <h4 class="my-1 text-warning">{{count($alluser)}}</h4>
                       <p class="mb-0 font-13">+8.4%</p>
                   </div>
            ...
            <div class="card-header">
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown ms-auto">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="javascript:;">Hành động</a>
                            </li>
                            ...
                            <li><a class="dropdown-item" href="javascript:;">Tính năng đang phát triển</a>
                            </li>
                        </ul>
                    </div>
                </div>
              ...
              <div class="card-body">
                <div class="d-flex align-items-center ms-auto font-13 gap-2 mb-3">
                    <span class="border px-1 rounded cursor-pointer"><i class="bx bxs-circle me-1" style="color: #14abef"></i>Bán</span>
                    <span class="border px-1 rounded cursor-pointer"><i class="bx bxs-circle me-1" style="color: #ffc107"></i>Thăm</span>
                </div>
              ...
              <div class="row row-cols-1 row-cols-md-3 row-cols-xl-3 g-0 row-group text-center border-top">
                <div class="col">
                  <div class="p-3">
                    ...
                    <small class="mb-0">Tất cả người ghé trang <span> <i class="bx bx-up-arrow-alt align-middle"></i> 2.43%</span></small>
                  </div>
                </div>
                <div class="col">
                  <div class="p-3">
                    <h5 class="mb-0">12:38</h5>
                    <small class="mb-0">Thời gian  <span> <i class="bx bx-up-arrow-alt align-middle"></i> 12.65%</span></small>
                  </div>
                </div>
                <div class="col">
                  <div class="p-3">
                    <h5 class="mb-0">639.82</h5>
                    <small class="mb-0">Trang/Ghé nhiều nhất <span> <i class="bx bx-up-arrow-alt align-middle"></i> 5.62%</span></small>
                  </div>
                </div>
              </div>
          </div>
