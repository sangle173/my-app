...
{{--                        <li>{{ $setting->address }}</li>--}}
                    ...
                    <h3 class="fs-20 font-weight-semi-bold pt-4 pb-2">Mạng xã hội:</h3>
            ...
            <div class="col-lg-3 responsive-column-half">
                <div class="footer-item">
                    <h3 class="fs-20 font-weight-semi-bold">Thông tin liên hệ</h3>
                    <span class="section-divider section--divider"></span>
                    <ul class="generic-list-item">
                        <li><a href="#">Sdt: 0905 123 456</a></li>
                        <li><a href="#">Email: luyenthicongchuc.ad@gmail.com</a></li>
                    </ul>
                </div><!-- end footer-item -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column-half">
...
{{--                        <li><a href="#">Garbage Collectors</a></li>--}}
            ...
            <div class="col-lg-3 responsive-column-half">
                <div class="footer-item">
                    <h3 class="fs-20 font-weight-semi-bold">Địa chỉ</h3>
                    <span class="section-divider section--divider"></span>
                    <div class="mobile-app">
                        <p class="pb-3 lh-24">Đà nẵng</p>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12 text-center">
                    <p class="copy-desc"> Bản quyền thuộc về: luyenthicongchuc.com</p>
                </div><!-- end col-lg-6 -->
{{--                <div class="col-lg-6">--}}
