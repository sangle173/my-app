...
<div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between mb-5">
    <div class="media media-card align-items-center">
        ...
        <div class="media-body">
            <h2 class="section__title fs-30">Xin chào, {{ $profileData->name }}</h2>
        ...
        <div class="media media-card align-items-center">
            ...
            <div class="media-body">
                <div class="file-upload-wrap file-upload-wrap-2">
                    <input type="file" name="photo" class="multi file-upload-input with-preview" accept="image/png, image/jpg" multiple>
            ...
            <div class="input-box col-lg-12 py-2">
                <button class="btn theme-btn">Lưu thông tin</button>
            </div><!-- end input-box -->
        </form>
