...
<section class="contact-area section--padding position-relative">
    ...
    <div class="container">
        ...
        <div class="text-center pt-3 pb-4">
            <div class="icon-element icon-element-md fs-25 shadow-sm">hoặc</div>
        </div>
        <div class="input-box">
            <label class="label-text">Email</label>
            <div class="form-group">
                <input class="form-control form--control" id="email" type="email" name="email" placeholder="Nhập email">
        ...
        <div class="btn-box">
            <div class="d-flex align-items-center justify-content-between pb-4">
                <div class="custom-control custom-checkbox fs-15">
                    ...
                    <label class="custom-control-label custom--control-label" for="rememberMeCheckbox">Ghi nhớ</label>
