...
class AdminController extends Controller
{
    ...
    public function AdminProfileStore(Request $request){
        ...
        $notification = array(
            'message' => 'Thông tin của bạn đã được cập nh',
            'alert-type' => 'success'
        );
    ...
    public function AddInstructor(){
        $roles = Role::all();
        return view('admin.backend.pages.admin.add_instructor',compact('roles'));
    }// End Method
    ...
    public function AddUser(){
        $roles = Role::all();
        return view('admin.backend.pages.admin.add_user',compact('roles'));
    }// End Method
    ...
    public function EditInstructor($id){
        ...
        $user = User::find($id);
        $roles = Role::all();
        return view('admin.backend.pages.admin.edit_instructor',compact('user','roles'));
    ...
    public function EditUser($id){
        ...
        $user = User::find($id);
        $roles = Role::all();
        return view('admin.backend.pages.admin.edit_user',compact('user','roles'));
